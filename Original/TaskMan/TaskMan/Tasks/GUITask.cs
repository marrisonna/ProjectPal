...
namespace TaskMan.Tasks
{
    public class GUITask : CustomGUIControls.Grid.IGridItem
    {
        ...
        internal DBTaskMan.Task DBTask { get { return m_dbTask; } }

        private DBTaskMan.Task m_dbTask;
        ...
        public void SetField(string columnName, string value)
        {
            switch (columnName)
            {
                ...
                case GUITaskColumns.s_Owner:
                    {
                        Person newOwner = DBTaskMan.Person.FindPerson(value);
        ...
        static public GUITask GetInstanceFromDBTask(DBTaskMan.Task dbTask)
        {
            GUITask result = null;
        ...
        static public GUITask GetExistingInstanceFromDBTask(DBTaskMan.Task dbTask)
        {
            GUITask result = null;
        ...
        static Dictionary<DBTaskMan.Task, GUITask> m_instances = new Dictionary<DBTaskMan.Task, GUITask>();

        private GUITask(DBTaskMan.Task dbTask)
        {
            ...
            get
            {
                ...
                else
                {
                    ...
                    double max = parentProjectPriorityList.Count == 0 ? 0.5 :
                                DBTaskMan.Enums.PriorityValueAsInt(parentProjectPriorityList[0]) + 0.5;
                    double min = Math.Max(0, max - 1);


                    for (int i = 1; i < parentProjectPriorityList.Count; i++)
                    {
                        double thisPriorityMax = DBTaskMan.Enums.PriorityValueAsInt(parentProjectPriorityList[i]) + 0.5;
                    ...
                    if (m_dbTask.Priority.HasValue)
                        thisTaskPriority = DBTaskMan.Enums.PriorityValueAsInt(m_dbTask.Priority.Value);
        ...
        public double Urgency_orig
        {
            get
            {
                ...
                int N = DBTaskMan.Enums.PriorityValueAsInt(thisPriority);
                if (N > 0)
                {
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case GUITaskColumns.s_priortyVHigh:
                        m_dbTask.Priority = DBTaskMan.PriorityValue._5_High;
                        break;
                    case GUITaskColumns.s_priortyHigh:
                        m_dbTask.Priority = DBTaskMan.PriorityValue._4_MedHigh;
                        break;
                    case GUITaskColumns.s_priortyMed:
                        m_dbTask.Priority = DBTaskMan.PriorityValue._3_Med;
                        break;
                    case GUITaskColumns.s_priortyLow:
                        m_dbTask.Priority = DBTaskMan.PriorityValue._2_MedLow;
                        break;
                    case GUITaskColumns.s_priortyVLow:
                        m_dbTask.Priority = DBTaskMan.PriorityValue._1_Low;
                        break;
                    case GUITaskColumns.s_priortyCancelled:
                        m_dbTask.Priority = DBTaskMan.PriorityValue._0_Cancelled;
                        break;
                    case GUITaskColumns.s_priortyClosed:
                        m_dbTask.Priority = DBTaskMan.PriorityValue._0_Closed;
                        break;
                    default:
                        m_dbTask.Priority = null;
                        break;
        ...
        public string ResourcesString
        {
            get
            {
                ...
                bool firstTime = true;
                foreach (DBTaskMan.IResource resource in m_dbTask.Resources)
                {
                    if (!firstTime)
        ...
        public string ProjectsString
        {
            get
            {
                ...
                DBTaskMan.Project project = m_dbTask.Project;
                if (project != null)
                {
        ...
        public string Project
        {
            ...
            set
            {
                ...
                Project newProject = DBTaskMan.Project.FindProject(value);
        ...
        public string EffortType
        {
            ...
            set
            {
                ...
                m_dbTask.EffortType = (DBTaskMan.EffortTypeValue)Enum.Parse(typeof(DBTaskMan.EffortTypeValue), value);
            }
        ...
        static public void Redisplay(DBTaskMan.Task task)
        {
        ...
        {
            TaskMan.Tasks.GUITask guiTask = task as TaskMan.Tasks.GUITask;
            if (guiTask != null)
            {
        ...
        public void GridCellDragDrop(DragEventArgs e)
        {
            if ((e.AllowedEffect | DragDropEffects.Link) != 0)
            {
                ...
                if (draggedTask != null)
                {
                    DBTaskMan.Task firstTask = DBTask;
                    DBTaskMan.Task secondTask = draggedTask.DBTask;
