...
namespace TaskMan.Components
{
    public class GUIComponent : CustomGUIControls.IDisplayItem
    {
        ...
        private DBTaskMan.Component m_dbComponent;
        public DBTaskMan.Component DBComponent { get { return m_dbComponent; } }
        ...
        public IList<GUIComponent> SubItems
        {
            get
            {
                ...
                foreach (DBTaskMan.Component currentComponent in m_dbComponent.SubComponents)
                {
        ...
        public IList<CustomGUIControls.Grid.IGridItem> Tasks(GUIComponent.TasksDisplayValues taskToDisplay)
        {
                ...
                foreach (DBTaskMan.Task currentTask in m_dbComponent.Tasks)
                {
        ...
        static public GUIComponent GetInstanceFromDBComponent(DBTaskMan.Component dbComponent)
        {
        ...
        static Dictionary<DBTaskMan.Component, GUIComponent> m_instances = new Dictionary<DBTaskMan.Component, GUIComponent>();

        private GUIComponent(DBTaskMan.Component dbComponent)
        {
            this.ID = s_nextId;
        ...
        static public void Redisplay(DBTaskMan.Component component)
        {
        ...
        static public void DeleateAllDisplayItems(DBTaskMan.Component theComponent)
        {
            GUIComponent guiComponent;
        ...
        public void SetNewParent(DBTaskMan.Component newParent)
        {
            DBTaskMan.Component currentParent = m_dbComponent.Parent;
