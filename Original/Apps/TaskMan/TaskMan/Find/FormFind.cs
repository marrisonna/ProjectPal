    ...
    public partial class FormFind : Form
    {
            ...
            if (foundItem != null)
            {
                ...
                if (foundItem.FoundItem is Remark)
                {
                    ...
                    if (theRemark != null)
                    {
                        ...
                        TaskDetail window = TaskMan.Tasks.TaskDetail.GetAndShowDetailWindow(theGuiTask);
                        window.ShowRemark(TaskMan.Remarks.GUIRemark.GetInstanceFromDBRemark(theRemark));
                    }
                ...
                if (foundItem.FoundItem is DBTaskMan.Component)
                {
                    DBTaskMan.Component theComponent = foundItem.FoundItem as DBTaskMan.Component;
                ...
                if (foundItem.FoundItem is DBTaskMan.Project)
                {
                    DBTaskMan.Project theProject = foundItem.FoundItem as DBTaskMan.Project;
                    if (theProject != null)
                    {
        ...
        private void buttonFind_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (SearchTasks)
                    sourceItems.AddRange(DBTaskMan.Task.AllInstances);
                if (SearchComponents)
                    sourceItems.AddRange(DBTaskMan.Component.AllInstances);
                if (SearchProjects)
                    sourceItems.AddRange(DBTaskMan.Project.AllInstances);
                if (SearchRemarks)
                    sourceItems.AddRange(DBTaskMan.Remark.AllInstances);
