...
namespace DBTaskMan
{
    public class Project : DBAccess.DBObject<Project>, ISearchable, ITaskOrProject
    {
        ...
        public void PerserveDependantsStartDatesForLastTask(DBTaskMan.Task lastTask)
        {
        ...
        public void ResetStartDate(bool resetChildProjects)
        {
            ...
            foreach (DBTaskMan.Task currentTask in this.Tasks)
            {
            ...
            else if (minStartDate != this.StartDate)
            {
                ...
                foreach (DBTaskMan.Task currentTask in this.TasksIncludingHidden)
                {
