...
namespace TaskMan.People
{
    public class GUIPerson : CustomGUIControls.Grid.IGridItem
    {
        ...
        internal DBTaskMan.Person DBPerson { get { return m_dbPerson; } }

        private DBTaskMan.Person m_dbPerson;
        ...
        static public GUIPerson GetInstanceFromDPerson(DBTaskMan.Person dbPerson)
        {
        ...
        static public GUIPerson GetExistingInstanceFromDBPerson(DBTaskMan.Person dbTask)
        {
            GUIPerson result = null;
        ...
        static Dictionary<DBTaskMan.Person, GUIPerson> m_instances = new Dictionary<DBTaskMan.Person, GUIPerson>();

        private GUIPerson(DBTaskMan.Person dbPerson)
        {
