...
namespace TaskMan.Remarks
{
    public class GUIRemark : CustomGUIControls.Grid.IGridItem
    {
        ...
        private DBTaskMan.Remark m_dbRemark;
        static public GUIRemark GetInstanceFromDBRemark(DBTaskMan.Remark dbRemark)
        {
        ...
        static Dictionary<DBTaskMan.Remark, GUIRemark> m_instances = new Dictionary<DBTaskMan.Remark, GUIRemark>();

        private GUIRemark(DBTaskMan.Remark dbRemark)
        {
        ...
        {
            TaskMan.Tasks.GUITask.GetInstanceFromDBTask(m_dbRemark.Task).Redisplay();
        }
