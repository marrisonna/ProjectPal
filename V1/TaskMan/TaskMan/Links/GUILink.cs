...
namespace TaskMan.Links
{
    public class GUILink : CustomGUIControls.Grid.IGridItem
    {
        ...
        private DBTaskMan.Link m_dbLink;
        static public GUILink GetInstanceFromDBLink(DBTaskMan.Link dbLink)
        {
            GUILink result = null;
        ...
        static Dictionary<DBTaskMan.Link, GUILink> m_instances = new Dictionary<DBTaskMan.Link, GUILink>();

        private GUILink(DBTaskMan.Link dbLink)
        {
        ...
        {
            TaskMan.Tasks.GUITask.GetInstanceFromDBTask(m_dbLink.Task).Redisplay();
        }
