...
See [`InitialDatabaseSetupPlan.md`](../Claude/DatabaseSetup/InitialDatabaseSetupPlan.md) for the full plan (downloads, configuration, schema design rationale, what's out of scope). This document is just the how-to.
