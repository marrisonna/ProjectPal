...
namespace ProjectPal.Attachments
{
    ...
    public class GUIAttachment : CustomGUIControls.Grid.IGridItem
    {
        ...
        private DBProjectPal.Attachment m_dbAttachment;
        static public GUIAttachment GetInstanceFromDBAttachment(DBProjectPal.Attachment dbAttachment)
        {
        ...
        static Dictionary<DBProjectPal.Attachment, GUIAttachment> m_instances = new Dictionary<DBProjectPal.Attachment, GUIAttachment>();

        private GUIAttachment(DBProjectPal.Attachment dbAttachment)
        {
