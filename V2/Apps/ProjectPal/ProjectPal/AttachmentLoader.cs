...
namespace ProjectPal
{
    class AttachmentLoader
    {
        ...
        private void ProcessAttachmentDirectory(string dir)
        {
            ...
            DBProjectPal.Task theTask = null;
            ...
            DBProjectPal.Component theComponent = null;
            if (!string.IsNullOrEmpty(itemNumber))
            {
                foreach (DBProjectPal.Component currentComponent in DBProjectPal.Component.AllInstances)
                {
            ...
            while ((line = detailsFile.ReadLine()) != null)
            {
                ...
                if(theTask != null)
                    DBProjectPal.Attachment.AddNewInstance(theTask, title, "Mail", from, messageDate, fileData);
                if(theComponent != null)
                    DBProjectPal.Attachment.AddNewInstance(theComponent, title, "Mail", from, messageDate, fileData);
