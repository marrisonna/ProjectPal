...
namespace TaskMan.Projects
{
    public partial class ProjectDetail : Form, IView
    {
        ...
        private static Dictionary<DBTaskMan.Project, ProjectDetail> s_allInstances = new Dictionary<DBTaskMan.Project, ProjectDetail>();
        ...
        private ProjectDetail(GUIProject rootProject)
        {
            ...
            m_theProjectsStackControl = new ProjectStackControl(TaskMan.Tasks.TaskDetail.ShowDetailWindow);
            ...
            {
                string currentUser = DBTaskMan.Person.FindPersonFromDBLogin(RootOwner).Name;
        ...
        private void Redisplay()
        {
            ...
            try
            {
                ...
                List<DBTaskMan.Project> projects = null;
                ...
                if (m_rootProject == null)
                {
                    ...
                    projects = new List<DBTaskMan.Project>();
                ...
                else
                {
                    ...
                    DBTaskMan.Person owner = DBTaskMan.Person.FindPersonFromDBLogin(m_rootProject.Owner);
                    ...
                    foreach (DBTaskMan.Attachment currentAttachement in m_rootProject.Attachments)
                    {
                    ...
                    if (m_rootProject.Owner == DBTaskMan.Person.DBUser)
                ...
                {
                    DBTaskMan.Project currentProjectToBeDisplayed = index < projects.Count ? projects[index] : null;
                ...
                //columnOrder.Add(TaskMan.Tasks.GUITask.s_Description);
                //columnOrder.Add(TaskMan.Tasks.GUITask.s_Priority);
                //columnOrder.Add(TaskMan.Tasks.GUITask.s_Urgency);
                //columnOrder.Add(TaskMan.Tasks.GUITask.s_DueDate);
                //columnOrder.Add(TaskMan.Tasks.GUITask.s_Status);
                //columnOrder.Add(TaskMan.Tasks.GUITask.s_Resources);
                //columnOrder.Add(TaskMan.Tasks.GUITask.s_Attachments);

                //CustomGUIControls.Component.ComponentControl ctrl = new CustomGUIControls.Component.ComponentControl(component);
                //foreach (DBTaskMan.Project currentProject in projects)
                //{
        ...
        DBTaskMan.Project m_rootProject = null;
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            if (result == System.Windows.Forms.DialogResult.OK)
            {
                ...
                DBTaskMan.Project theNewProject = DBTaskMan.Project.AddNewInstance(newProjectName, m_rootProject);
                Functions.ClearDisplayCaches();
                if (m_rootProject != null)
                    TaskMan.Projects.GUIProject.Redisplay(m_rootProject);
                else
                {
                    Redisplay();
                }
        ...
        private void gridControlAttachments_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                DBTaskMan.Attachment.AddNewInstance(m_rootProject, file.Title, file.Type, file.From, file.TimeStamp, file.FileContents);
                Functions.ClearDisplayCaches();
        ...
        private void labelParent_Click(object sender, EventArgs e)
        {
            ...
            DBTaskMan.Project parentProject = m_rootProject.Parent;
        ...
        {
            string user = DBTaskMan.Person.FindPerson(comboBoxNewOwner.Text).DBLogin.Trim();
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            TaskMan.Tasks.GUITask.UrgencyCachingEnabled = false;
        }
        ...
        private void RedisplayDependencies()
        {
            if (m_rootProject != null)
            {
                ...
                List<DBTaskMan.ITaskOrProject> preDependants = new List<DBTaskMan.ITaskOrProject>(m_rootProject.ImmediatePreDependencies);
                ...
                List<DBTaskMan.ITaskOrProject> postDependants = new List<DBTaskMan.ITaskOrProject>(m_rootProject.ImmediatePostDependants);
        ...
        private void listBoxDependency_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (itemSelected != null)
            {
                ...
                {
                    Tasks.GUITask theGuiTask = Tasks.GUITask.GetInstanceFromDBTask((DBTaskMan.Task)itemSelected);
        ...
        private void listBoxDependsUpon_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (draggedTask != null)
            {
                DBTaskMan.Project postProject = m_rootProject;
        ...
        private void listBoxDependants_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (draggedTask != null)
            {
                DBTaskMan.Project preProject = m_rootProject;
