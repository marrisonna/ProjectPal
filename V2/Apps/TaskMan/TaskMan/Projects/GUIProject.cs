...
namespace TaskMan.Projects
{
    ...
    {
        private DBTaskMan.Project m_dbProject;
        public DBTaskMan.Project DBProject { get { return m_dbProject; } }
        ...
        public string Priority
        {
            get
            {
                ...
                {
                    case DBTaskMan.PriorityValue._5_High:
                        return GUIProjectColumns.s_priortyVHigh;
                    case DBTaskMan.PriorityValue._4_MedHigh:
                        return GUIProjectColumns.s_priortyHigh;
                    case DBTaskMan.PriorityValue._3_Med:
                        return GUIProjectColumns.s_priortyMed;
                    case DBTaskMan.PriorityValue._2_MedLow:
                        return GUIProjectColumns.s_priortyLow;
                    case DBTaskMan.PriorityValue._1_Low:
                        return GUIProjectColumns.s_priortyVLow;
                    case DBTaskMan.PriorityValue._0_Cancelled:
                        return GUIProjectColumns.s_priortyCancelled;
                    case DBTaskMan.PriorityValue._0_Closed:
            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case GUIProjectColumns.s_priortyVHigh:
                        m_dbProject.Priority = DBTaskMan.PriorityValue._5_High;
                        break;
                    case GUIProjectColumns.s_priortyHigh:
                        m_dbProject.Priority = DBTaskMan.PriorityValue._4_MedHigh;
                        break;
                    case GUIProjectColumns.s_priortyMed:
                        m_dbProject.Priority = DBTaskMan.PriorityValue._3_Med;
                        break;
                    case GUIProjectColumns.s_priortyLow:
                        m_dbProject.Priority = DBTaskMan.PriorityValue._2_MedLow;
                        break;
                    case GUIProjectColumns.s_priortyVLow:
                        m_dbProject.Priority = DBTaskMan.PriorityValue._1_Low;
                        break;
                    case GUIProjectColumns.s_priortyCancelled:
                        m_dbProject.Priority = DBTaskMan.PriorityValue._0_Cancelled;
                        break;
                    case GUIProjectColumns.s_priortyClosed:
                        m_dbProject.Priority = DBTaskMan.PriorityValue._0_Closed;
                        break;
                    default:
                        m_dbProject.Priority = null;
                        break;
        ...
        static public GUIProject GetInstanceFromDBProject(DBTaskMan.Project dbProject)
        {
        ...
        static Dictionary<DBTaskMan.Project, GUIProject> m_instances = new Dictionary<DBTaskMan.Project, GUIProject>();

        private GUIProject(DBTaskMan.Project dbProject)
        {
        ...
        {
            foreach (DBTaskMan.Task aTask in m_dbProject.Tasks)
            {
                TaskMan.Tasks.GUITask.Redisplay(aTask);
            }
            foreach (DBTaskMan.Project aProject in m_dbProject.SubProjects)
            {
        ...
        static public void Redisplay(DBTaskMan.Project project)
        {
            GUIProject guiProject = null;
        ...
        static public void DeleateAllDisplayItems(DBTaskMan.Project theProject)
        {
            GUIProject guiProject = null;
        ...
        public void SetNewParent(DBTaskMan.Project newParent)
        {
            DBTaskMan.Project currentParent = m_dbProject.Parent;
        ...
        public IList<CustomGUIControls.Grid.IGridItem> Tasks(GUIProject.TasksDisplayValues taskToDisplay)
        {
            ...
            foreach (DBTaskMan.Task currentTask in m_dbProject.Tasks)
            {
                if (taskToDisplay == TasksDisplayValues.All ||
                    (currentTask.Status.Value != DBTaskMan.StatusValue.Cancelled &&
                     currentTask.Status.Value != DBTaskMan.StatusValue.Closed))
                    tasks.Add(TaskMan.Tasks.GUITask.GetInstanceFromDBTask(currentTask));
            }
            return tasks;
        }
        ...
        public IList<GUIProject> SubItems
        {
            get
            {
                ...
                foreach (DBTaskMan.Project currentProject in m_dbProject.SubProjects)
                {
        ...
        public object GetFieldValue(string columnName)
        {
            switch (columnName)
            {
                ...
                case GUIProjectColumns.s_Owner:
                    {
                        DBTaskMan.Person projectOwner = DBTaskMan.Person.FindPersonFromDBLogin(Owner);
        ...
        {
            if (DBProject.Priority == DBTaskMan.PriorityValue._0_Cancelled ||
                DBProject.Priority == DBTaskMan.PriorityValue._0_Closed ||
        ...
        public static int SortProjectsByPriority(DBTaskMan.Project a, DBTaskMan.Project b)
        {
            int priorityA = a == null ? -10 : DBTaskMan.Enums.PriorityValueAsInt(a.Priority ?? DBTaskMan.PriorityValue._3_Med);
            int priorityB = b == null ? -10 : DBTaskMan.Enums.PriorityValueAsInt(b.Priority ?? DBTaskMan.PriorityValue._3_Med);
        ...
        public static int SortProjectsByPriority(DBTaskMan.Project a, GUIProject b)
        {
            return SortProjectsByPriority(a, b.DBProject);
        }

        public static int SortProjectsByPriority(GUIProject a, DBTaskMan.Project b)
        {
