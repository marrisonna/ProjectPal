                ...
                case s_AffectedComponent:
                    {
                        ...
                        foreach (Component aComponent in DBTaskMan.Component.AllInstances)
                        {
                ...
                case s_Resources:
                    {
                        ...
                        foreach (Person aPerson in DBTaskMan.Person.AllActiveInstances)
                        {
                ...
                case s_Projects:
                    {
                        ...
                        foreach (Project aProject in DBTaskMan.Project.AllInstances)
                        {
