...
{
    class ApplicationProjectPal
    {
        static private ApplicationProjectPal m_instance = null;
        static public ApplicationProjectPal Instance
        {
            get
            {
                if (m_instance == null)
                    m_instance = new ApplicationProjectPal();
                return m_instance;
            }
        }
        ...
        public void RefreshFromDatabase()
        {
            ...
            {
                ProjectPal.Tasks.GUITask.Redisplay(t);
            }
        ...
        public void RefreshAllWindows()
        {
            ...
            try
            {
                ProjectPal.Tasks.TaskDetail.RedisplayAll();


                ProjectPal.Components.ComponentWindow.RedisplayAll();
                ProjectPal.Components.GUIComponent.RedisplayAll();
                ProjectPal.Projects.ProjectDetail.RedisplayAll();
                ProjectPal.Projects.GUIProject.RedisplayAll();
                ProjectPal.Projects.FormPlanDisplay.RedisplayAll();
                // TODO - Need to redisplay complete Task Windows, not just Gantts
                ProjectPal.Tasks.TaskWindow.RedisplayAll();
                ProjectPal.Components.ComponentWindow.RedisplayAllGantts();
